...
class CreateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'transaction_type_id.required' => __('validation.required', ['attribute' => __('Transaction Type')]),
            'transaction_type_id.exists' => __('validation.exists', ['attribute' => __('Transaction Type')]),
