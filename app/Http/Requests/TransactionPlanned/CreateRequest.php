...
namespace App\Http\Requests\TransactionPlanned;
...
class CreateRequest extends FormRequest
{
    ...
    {
        return [
            'frequency' => 'required|in:' . implode(',', Period::frequencyValues()),
            'period_start_date' => 'required|date_format:Y-m-d',
            'period_end_date' => 'date_format:Y-m-d|after_or_equal:period_start_date',
            ...
            'installments.*.installment_date' => 'required_if:payment_type,credit|date|after_or_equal:period_start_date',
        ];
    }
    ...
    {
        return [
            'frequency.required' => __('validation.required', ['attribute' => __('Frequency')]),
            'frequency.in' => __('validation.in', ['attribute' => __('Frequency')]),
            'period_start_date.required' => __('validation.required', ['attribute' => __('Period Start Date')]),
            'period_start_date.date_format' => __('validation.date_format', ['attribute' => __('Period Start Date'), 'format' => 'Y-m-d']),
            'period_end_date.date_format' => __('validation.date_format', ['attribute' => __('Period End Date'), 'format' => 'Y-m-d']),
            'period_end_date.after_or_equal' => __('validation.after_or_equal', ['attribute' => __('Period End Date'), 'date' => __('Period Start Date')]),
