...
<div class="container">
    <div class="row">
        <div class="col">
            <form method="post" action="{{route('createMovement')}}">
                @csrf
                <div class="container">
                    ...
                    <input type="date" class="form-control" name="movement_date" id="movement_date" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" required>
                    <br />
