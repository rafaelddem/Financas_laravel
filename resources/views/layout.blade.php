        ...
        <div class="menu-scroll">
            <ul class="menu-main">
                ...
                <ul class="submenu transactions">
                    ...
                    <li class="navbar-item"><a href="{{route('transaction-planned.list')}}"><i class="fa-solid fa-arrows-spin"></i><span>{{__('Transactions Planned Entry')}}</span></a></li>
        ...
        <div class="menu-final">
            <ul>
                ...
                <ul class="submenu login">
                    @can('admin')
                        <li class="navbar-item"><a href="{{route('configuration.index')}}"><i class="fa-solid fa-gear"></i><span>{{__('Configurations')}}</span></a></li>
                    @endcan
